...
import { Bubble, BubbleContent } from "@lyra/ui/components/bubble";
...
import {
  ...
  EmptyMedia,
  EmptyTitle,
} from "@lyra/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@lyra/ui/components/input-group";
import { Message, MessageContent as MessageBody, MessageHeader } from "@lyra/ui/components/message";
import {
  MessageScroller,
...
} from "@lyra/ui/components/message-scroller";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, lyra!</EmptyTitle>
